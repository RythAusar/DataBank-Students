...
DROP USER IF EXISTS `placeHolderName`@`localhost`;
CREATE USER IF NOT EXISTS 'placeHolderName'@'localhost' IDENTIFIED BY 'placeHolderPassword';
GRANT ALL ON `databank`.* TO 'placeHolderName'@'localhost';
