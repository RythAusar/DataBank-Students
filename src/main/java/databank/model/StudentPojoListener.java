...
/**
 * TODO 21 - What annotations should be used on these methods?DONE!
 * https://www.logicbig.com/tutorials/java-ee-tutorial/jpa/entity-listeners.html<br>
 */
public class StudentPojoListener {

	//TODO 22 - Called before persist to add the dates.DONE!
	@PrePersist
	...
	//TODO 23 - Called before update to update the date.DONE!
	@PreUpdate
